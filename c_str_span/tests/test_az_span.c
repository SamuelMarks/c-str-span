...
static void test_az_span_is_content_equal(void **state) {
  ...
  assert_true(az_span_is_content_equal(az_span_slice_to_end(a, 3),
  ...
  assert_true(az_span_is_content_equal(AZ_SPAN_FROM_STR(""),
...
static void az_span_atou32_test(void **state) {
  ...
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("2147483647"), &value),
                   AZ_OK);
  assert_int_equal(value, 2147483647);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("4294967295"), &value),
                   AZ_OK);
  assert_int_equal(value, 4294967295);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("00004294967295"), &value),
                   AZ_OK);
  assert_int_equal(value, 4294967295);

  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("-123"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("42949672950"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("-2147483648"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("-4294967295"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("-4294967296"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("4294967296"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("42949672950"), &value),
...
static void az_span_atoi32_test(void **state) {
  ...
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("2147483647"), &value),
                   AZ_OK);
  assert_int_equal(value, 2147483647);
  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("-2147483648"), &value),
                   AZ_OK);
  assert_int_equal(value, -2147483647 - 1);
  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("-00002147483648"), &value),
                   AZ_OK);
  assert_int_equal(value, -2147483647 - 1);

  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("21474836470"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("2147483648"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("-2147483649"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("-4294967295"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("-4294967296"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
...
static void az_span_atou64_test(void **state) {
  ...
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atou64(AZ_SPAN_FROM_STR("2147483647"), &value),
                   AZ_OK);
  assert_int_equal(value, 2147483647);
  assert_int_equal(az_span_atou64(AZ_SPAN_FROM_STR("4294967295"), &value),
                   AZ_OK);
  assert_int_equal(value, 4294967295);
  assert_int_equal(
      az_span_atou64(AZ_SPAN_FROM_STR("9223372036854775807"), &value), AZ_OK);
  assert_int_equal(value, 9223372036854775807UL);
  assert_int_equal(
      az_span_atou64(AZ_SPAN_FROM_STR("18446744073709551615"), &value), AZ_OK);
  assert_int_equal(value, 18446744073709551615UL);
  assert_int_equal(
      az_span_atou64(AZ_SPAN_FROM_STR("000018446744073709551615"), &value),
      AZ_OK);
  assert_int_equal(value, 18446744073709551615UL);

  assert_int_equal(az_span_atou64(AZ_SPAN_FROM_STR("-123"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
...
static void az_span_atoi64_test(void **state) {
  ...
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atoi64(AZ_SPAN_FROM_STR("2147483647"), &value),
                   AZ_OK);
  assert_int_equal(value, 2147483647);
  assert_int_equal(az_span_atoi64(AZ_SPAN_FROM_STR("-2147483648"), &value),
                   AZ_OK);
  assert_int_equal(value, -2147483647 - 1);
  assert_int_equal(az_span_atoi64(AZ_SPAN_FROM_STR("4294967295"), &value),
                   AZ_OK);
  assert_int_equal(value, 4294967295);
  assert_int_equal(az_span_atoi64(AZ_SPAN_FROM_STR("-4294967296"), &value),
                   AZ_OK);
  assert_int_equal(value, -4294967296);
  assert_int_equal(
      az_span_atoi64(AZ_SPAN_FROM_STR("9223372036854775807"), &value), AZ_OK);
  assert_int_equal(value, 9223372036854775807L);
  assert_int_equal(
      az_span_atoi64(AZ_SPAN_FROM_STR("-9223372036854775808"), &value), AZ_OK);
  assert_int_equal(value, -9223372036854775807L - 1);
  assert_int_equal(
      az_span_atoi64(AZ_SPAN_FROM_STR("-00009223372036854775808"), &value),
      AZ_OK);
  assert_int_equal(value, -9223372036854775807L - 1);
...
static void az_span_atod_test(void **state) {
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-2147483648"), &value),
                   AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-4294967296"), &value),
                   AZ_OK);
  assert_true(value == -4294967296);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("9223372036854775807"), &value), AZ_OK);
  assert_true(value == (double)LLONG_MAX);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("-9223372036854775808"), &value), AZ_OK);
  assert_true(value == (double)LLONG_MIN);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-123.456e-78"), &value),
                   AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("0.000000000000001"), &value),
                   AZ_OK);
  assert_true(value == 0.000000000000001);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("1.0000000001"), &value),
                   AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("00100.00100"), &value),
                   AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-9876.54321"), &value),
                   AZ_OK);
  assert_true(value == -9876.54321);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("987654.321"), &value), AZ_OK);
  assert_true(value == 987654.321);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-987654.321"), &value),
                   AZ_OK);
  assert_true(value == -987654.321);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("987654.0000321"), &value),
                   AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-2147483648"), &value),
                   AZ_OK);
  assert_true(value == -2147483647 - 1);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("4503599627370496"), &value),
                   AZ_OK);
  assert_true(value == 4503599627370496);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("9007199254740991"), &value),
                   AZ_OK);
  assert_true(value == 9007199254740991);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("4503599627370496.2"), &value),
                   AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("0.1234567890123456"), &value),
                   AZ_OK);
  ...
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("123456789012345.1234567890123400001"),
                   &value),
      AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("12345.123e-15"), &value),
                   AZ_OK);
  assert_true(value == 12345.123e-15);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("12345.12300000010e5"), &value), AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("9007199254740992"), &value),
                   AZ_OK);
  assert_true(value == 9007199254740992);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("9007199254740993"), &value),
                   AZ_OK);
  assert_true(value == 9007199254740993);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("45035996273704961"), &value),
                   AZ_OK);
  assert_true(value == 45035996273704961);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("9223372036854775806"), &value), AZ_OK);
  assert_true(value == 9223372036854775806);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("-9223372036854775806"), &value), AZ_OK);
  assert_true(value == -9223372036854775806);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("1844674407370955100"), &value), AZ_OK);
  assert_true(value == 1844674407370955100);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("1.844674407370955e+19"), &value), AZ_OK);
  assert_true(value == 1.844674407370955e+19);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("1.8446744073709551e+19"), &value), AZ_OK);
  assert_true(value == 1.8446744073709551e+19);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("1.8446744073709552e+19"), &value), AZ_OK);
  assert_true(value == 1.8446744073709552e+19);
  assert_int_equal(
      az_span_atod(AZ_SPAN_FROM_STR("18446744073709551615"), &value), AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("12345.123e15"), &value),
                   AZ_OK);
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-1.7e308"), &value), AZ_OK);
  assert_true(value == -1.7e308);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("2.22507e-308"), &value),
                   AZ_OK);
...
static void az_span_atod_non_finite_not_allowed(void **state) {
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("nan"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-nan"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("+nan"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("inf"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("+inf"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-inf"), &value),
  ...
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-INF"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("INFINITY"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("+INFINITY"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-INFINITY"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("1.8e308"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("-1.8e308"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("1.8e309"), &value),
                   AZ_ERROR_UNEXPECTED_CHAR);
}
...
static void az_span_ato_number_whitespace_or_invalid_not_allowed(void **state) {
  ...
  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("   123"), &value_i32),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("   123"), &value_u32),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atoi64(AZ_SPAN_FROM_STR("   123"), &value_i64),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou64(AZ_SPAN_FROM_STR("   123"), &value_u64),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("   123"), &value_d),
                   AZ_ERROR_UNEXPECTED_CHAR);
  ...
  assert_int_equal(az_span_atoi32(AZ_SPAN_FROM_STR("a123"), &value_i32),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(AZ_SPAN_FROM_STR("a123"), &value_u32),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atoi64(AZ_SPAN_FROM_STR("a123"), &value_i64),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou64(AZ_SPAN_FROM_STR("a123"), &value_u64),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(AZ_SPAN_FROM_STR("a123"), &value_d),
                   AZ_ERROR_UNEXPECTED_CHAR);
...
static void az_span_ato_number_no_out_of_bounds_reads(void **state) {
  ...
  assert_int_equal(az_span_atoi32(az_span_slice(source, 0, 6), &value_i32),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_slice(source, 0, 6), &value_d),
                   AZ_ERROR_UNEXPECTED_CHAR);

  assert_int_equal(az_span_atoi32(az_span_slice(source, 3, 6), &value_i32),
                   AZ_OK);
  ...
  assert_int_equal(az_span_atoi32(az_span_slice(source, 3, 6), &value_i32),
                   AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_slice(source, 3, 6), &value_d),
                   AZ_ERROR_UNEXPECTED_CHAR);

  source = AZ_SPAN_FROM_STR("n1");
  assert_int_equal(az_span_atoi32(source, &value_i32),
                   AZ_ERROR_UNEXPECTED_CHAR);
...
static void
az_span_find_target_overlap_continuation_of_source_fails(void **state) {
...
static void
az_span_find_target_more_chars_than_prefix_of_source_fails(void **state) {
  az_span span = AZ_SPAN_FROM_STR("abcd");
...
static void az_span_find_capacity_checks_success(void **state) {
  ...
  assert_int_equal(
      az_span_find(az_span_create(buffer, 2), az_span_create(buffer, 2)), 0);
  assert_int_equal(
      az_span_find(az_span_create(buffer, 2), az_span_create(buffer, 0)), 0);
  assert_int_equal(
      az_span_find(az_span_create(buffer, 0), az_span_create(buffer, 0)), 0);

  assert_int_equal(
      az_span_find(az_span_create(buffer, 2), az_span_create(buffer + 1, 2)),
      0);
  assert_int_equal(
      az_span_find(az_span_create(buffer + 1, 2), az_span_create(buffer, 2)),
      0);
  assert_int_equal(az_span_find(az_span_create(buffer + 1, 2),
                                az_span_create(buffer + 1, 2)),
                   0);
  assert_int_equal(
      az_span_find(az_span_create(buffer, 2), az_span_create(buffer + 2, 2)),
      0);
  assert_int_equal(
      az_span_find(az_span_create(buffer + 2, 2), az_span_create(buffer, 2)),
      0);
}
...
static void az_span_find_overlapping_checks_success(void **state) {
  ...
  assert_int_equal(az_span_find(source, az_span_slice(span, 1, 5)),
                   FAIL_SIZE_T_VAL);
...
static void az_span_i32toa_overflow_fails(void **state) {
  ...
  assert_true(az_span_i32toa(buffer, v, &out_span) ==
...
static void az_span_u32toa_overflow_fails(void **state) {
  ...
  assert_true(az_span_u32toa(buffer, v, &out_span) ==
              AZ_ERROR_NOT_ENOUGH_SPACE);
}
...
#define AZ_SPAN_DTOA_SUCCEEDS_HELPER(v, fractional_digits, expected)           \
  do {                                                                         \
    ...
    assert_memory_equal(az_span_ptr(output), az_span_ptr(expected),            \
...
static void az_span_dtoa_overflow_fails(void **state) {
  ...
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 0), 0, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 0), 1., 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 3), 1.e3, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 0), 1, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 1), -1, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 4), 12345, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 5), -12345, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 10), 123.123, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 5), 123.0100, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(
  ...
  assert_int_equal(
      ...
      AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 7), 100.001, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 4), 0.001, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 10), 0.0012, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 4), 1.2e4, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 6), 1.2e-4, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 4), 1.2e+4, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 5), -1.2e4, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 7), -1.2e-4, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 4), 0.0001, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 5), 0.00102, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 5), .34567, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 6), -.34567, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 10), 9876.54321, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(
      az_span_dtoa(az_span_slice(buff, 0, 11), -9876.54321, 15, &o),
      AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 10), 987654.321, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(
  ...
  assert_int_equal(
      ...
      AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 9), 2147483647, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(
  ...
  assert_int_equal(
      ...
      AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 15),
                                (double)4503599627370496.2, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 14), 1e15, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 15), -1e15, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 10), 1.8e10, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 11), -1.8e10, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 15), 1e-15, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 10), 1e-10, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 5), 1e-5, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(
      az_span_dtoa(az_span_slice(buff, 0, 16), 0.1234567890123456, 15, &o),
      AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 18),
                                123456789012345.123456789012340000, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 26),
  ...
  assert_int_equal(
      ...
      AZ_ERROR_NOT_ENOUGH_SPACE);
  assert_int_equal(az_span_dtoa(az_span_slice(buff, 0, 0), 1e-300, 15, &o),
                   AZ_ERROR_NOT_ENOUGH_SPACE);
...
static void az_span_dtoa_too_large(void **state) {
  ...
  assert_int_equal(az_span_dtoa(buff, 9007199254740992, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, (double)9007199254740993, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, (double)45035996273704961, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, 2147483647 * (double)4294967298, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, -2147483647 * (double)4294967298, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, (double)1844674407370955100, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, (double)1.844674407370955e+19, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, (double)1.8446744073709551e+19, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, (double)1.8446744073709552e+19, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, (double)18446744073709551615UL, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(
  ...
  assert_int_equal(az_span_dtoa(buff, 12345.123e15, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
  assert_int_equal(az_span_dtoa(buff, -12345.123e15, 15, &o),
                   AZ_ERROR_NOT_SUPPORTED);
...
static void test_az_span_overlap(void **state) {
  ...
  assert_false(_az_span_overlap(az_span_create((uint8_t *)10, 10),
                                az_span_create((uint8_t *)30, 10)));
  assert_false(_az_span_overlap(az_span_create((uint8_t *)30, 10),
                                az_span_create((uint8_t *)10, 10)));

  assert_false(_az_span_overlap(az_span_create((uint8_t *)10, 10),
                                az_span_create((uint8_t *)20, 10)));
  assert_false(_az_span_overlap(az_span_create((uint8_t *)20, 10),
                                az_span_create((uint8_t *)10, 10)));

  assert_false(_az_span_overlap(az_span_create((uint8_t *)10, 0),
                                az_span_create((uint8_t *)10, 0)));

  assert_true(_az_span_overlap(az_span_create((uint8_t *)10, 10),
                               az_span_create((uint8_t *)15, 0)));
  assert_true(_az_span_overlap(az_span_create((uint8_t *)15, 0),
                               az_span_create((uint8_t *)10, 10)));

  assert_true(_az_span_overlap(az_span_create((uint8_t *)10, 10),
                               az_span_create((uint8_t *)10, 15)));
  assert_true(_az_span_overlap(az_span_create((uint8_t *)10, 15),
                               az_span_create((uint8_t *)10, 10)));

  assert_true(_az_span_overlap(az_span_create((uint8_t *)15, 10),
                               az_span_create((uint8_t *)10, 15)));
  assert_true(_az_span_overlap(az_span_create((uint8_t *)10, 15),
  ...
  assert_true(_az_span_overlap(az_span_create((uint8_t *)5, 10),
                               az_span_create((uint8_t *)10, 10)));
  ...
  assert_true(_az_span_overlap(az_span_create((uint8_t *)12, 5),
                               az_span_create((uint8_t *)10, 10)));
}
...
static void test_az_span_token_success(void **state) {
  ...
  assert_true(az_span_ptr(out_span) ==
              (az_span_ptr(span) + az_span_size(delim)));
  assert_true(az_span_size(out_span) ==
