...
extern C_STR_SPAN_EXPORT az_precondition_failed_fn az_precondition_failed_get_callback(void);
...
AZ_UNUSED AZ_NODISCARD AZ_INLINE bool _az_span_is_valid(az_span span, size_t min_size, bool null_is_valid)
{
