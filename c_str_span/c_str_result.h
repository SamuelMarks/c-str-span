...
enum { _az_ERROR_FLAG = (int32_t)0x80000000 };
...
enum az_result_core {
  ...
  AZ_ERROR_DEPENDENCY_NOT_PROVIDED =
      _az_RESULT_MAKE_ERROR(_az_FACILITY_CORE, 8),
  ...
  AZ_ERROR_JSON_INVALID_STATE =
      _az_RESULT_MAKE_ERROR(_az_FACILITY_CORE_JSON, 1),

  /* / The JSON depth is too large. */
  AZ_ERROR_JSON_NESTING_OVERFLOW =
      _az_RESULT_MAKE_ERROR(_az_FACILITY_CORE_JSON, 2),
