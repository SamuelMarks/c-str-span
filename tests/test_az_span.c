...
{
  az_span a = az_span_create_from_str("one");
  az_span b = az_span_create_from_str("One");
  az_span c = az_span_create_from_str("ones");
  az_span d = az_span_create_from_str("ona");
...
static void test_az_span_is_content_equal(void** state)
{
  az_span a = az_span_create_from_str("one");
  az_span b = az_span_create_from_str("One");
  az_span c = az_span_create_from_str("one1");
  az_span d = az_span_create_from_str("done"); // d contains a
  ...
  assert_true(az_span_is_content_equal(a, az_span_create_from_str("one")));
  ...
  assert_true(az_span_is_content_equal(az_span_create_from_str(""), az_span_create_from_str("")));
  assert_true(az_span_is_content_equal(az_span_create_from_str(""), az_span_empty()));
  assert_true(az_span_is_content_equal(az_span_create_from_str(""), az_span_slice_to_end(a, 3)));
...
static void az_span_atox_return_errors(void** state)
{
  ...
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("test"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str(" "));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str(" 1"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("-"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("+"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("--1"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("++1"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("-+"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("+-"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("-0+"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("0-"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("+0-"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("1-"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("123a"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("123,"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("123 "));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("--123"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("-+123"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("+-123"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("  -1-"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("- INFINITY"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("- 0"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("+ 1"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("1.-e3"));
  AZ_SPAN_ATOX_RETURN_ERRORS_HELPER(az_span_create_from_str("1.-e/3"));
  az_SPAN_ATOX_RETURN_ERRORS_HELPER_EXCLUDE_DOUBLE(az_span_create_from_str("1.23"));
  az_SPAN_ATOX_RETURN_ERRORS_HELPER_EXCLUDE_DOUBLE(az_span_create_from_str("-1.23"));
  az_SPAN_ATOX_RETURN_ERRORS_HELPER_EXCLUDE_DOUBLE(az_span_create_from_str("11e2"));
  az_SPAN_ATOX_RETURN_ERRORS_HELPER_EXCLUDE_DOUBLE(az_span_create_from_str("-1.1e+2"));
  az_SPAN_ATOX_RETURN_ERRORS_HELPER_EXCLUDE_DOUBLE(az_span_create_from_str("1.23e3"));
  az_SPAN_ATOX_RETURN_ERRORS_HELPER_EXCLUDE_DOUBLE(az_span_create_from_str("99999999999999999999"));
  az_SPAN_ATOX_RETURN_ERRORS_HELPER_EXCLUDE_DOUBLE(az_span_create_from_str("999999999999999999999"));
  az_SPAN_ATOX_RETURN_ERRORS_HELPER_EXCLUDE_DOUBLE(az_span_create_from_str("18446744073709551616"));
  az_SPAN_ATOX_RETURN_ERRORS_HELPER_EXCLUDE_DOUBLE(az_span_create_from_str("-18446744073709551616"));
}
...
static void az_span_atou32_test(void** state)
{
  ...
  assert_int_equal(az_span_atou32(az_span_create_from_str("0"), &value), AZ_OK);
  assert_int_equal(value, 0);
  assert_int_equal(az_span_atou32(az_span_create_from_str("1024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atou32(az_span_create_from_str("+1024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atou32(az_span_create_from_str("001024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atou32(az_span_create_from_str("2147483647"), &value), AZ_OK);
  assert_int_equal(value, 2147483647);
  assert_int_equal(az_span_atou32(az_span_create_from_str("4294967295"), &value), AZ_OK);
  assert_int_equal(value, 4294967295);
  assert_int_equal(az_span_atou32(az_span_create_from_str("00004294967295"), &value), AZ_OK);
  assert_int_equal(value, 4294967295);

  assert_int_equal(az_span_atou32(az_span_create_from_str("-123"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("42949672950"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("-2147483648"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("-4294967295"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("-4294967296"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("4294967296"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("42949672950"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("9223372036854775807"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("9223372036854775808"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("18446744073709551615"), &value), AZ_ERROR_UNEXPECTED_CHAR);
}
...
static void az_span_atoi32_test(void** state)
{
  ...
  assert_int_equal(az_span_atoi32(az_span_create_from_str("0"), &value), AZ_OK);
  assert_int_equal(value, 0);
  assert_int_equal(az_span_atoi32(az_span_create_from_str("1024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atoi32(az_span_create_from_str("+1024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atoi32(az_span_create_from_str("-1024"), &value), AZ_OK);
  assert_int_equal(value, -1024);
  assert_int_equal(az_span_atoi32(az_span_create_from_str("001024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atoi32(az_span_create_from_str("2147483647"), &value), AZ_OK);
  assert_int_equal(value, 2147483647);
  assert_int_equal(az_span_atoi32(az_span_create_from_str("-2147483648"), &value), AZ_OK);
  assert_int_equal(value, -2147483647 - 1);
  assert_int_equal(az_span_atoi32(az_span_create_from_str("-00002147483648"), &value), AZ_OK);
  assert_int_equal(value, -2147483647 - 1);

  assert_int_equal(
      az_span_atoi32(az_span_create_from_str("21474836470"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi32(az_span_create_from_str("2147483648"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi32(az_span_create_from_str("-2147483649"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi32(az_span_create_from_str("-4294967295"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi32(az_span_create_from_str("-4294967296"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi32(az_span_create_from_str("9223372036854775807"), &value), AZ_ERROR_UNEXPECTED_CHAR);
}
...
static void az_span_atou64_test(void** state)
{
  ...
  assert_int_equal(az_span_atou64(az_span_create_from_str("0"), &value), AZ_OK);
  assert_int_equal(value, 0);
  assert_int_equal(az_span_atou64(az_span_create_from_str("1024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atou64(az_span_create_from_str("+1024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atou64(az_span_create_from_str("001024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atou64(az_span_create_from_str("2147483647"), &value), AZ_OK);
  assert_int_equal(value, 2147483647);
  assert_int_equal(az_span_atou64(az_span_create_from_str("4294967295"), &value), AZ_OK);
  assert_int_equal(value, 4294967295);
  assert_int_equal(az_span_atou64(az_span_create_from_str("9223372036854775807"), &value), AZ_OK);
  assert_int_equal(value, 9223372036854775807UL);
  assert_int_equal(az_span_atou64(az_span_create_from_str("18446744073709551615"), &value), AZ_OK);
  assert_int_equal(value, 18446744073709551615UL);
  assert_int_equal(az_span_atou64(az_span_create_from_str("000018446744073709551615"), &value), AZ_OK);
  assert_int_equal(value, 18446744073709551615UL);

  assert_int_equal(az_span_atou64(az_span_create_from_str("-123"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou64(az_span_create_from_str("184467440737095516150"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou64(az_span_create_from_str("18446744073709551616"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou64(az_span_create_from_str("-9223372036854775809"), &value), AZ_ERROR_UNEXPECTED_CHAR);
}
...
static void az_span_atoi64_test(void** state)
{
  ...
  assert_int_equal(az_span_atoi64(az_span_create_from_str("0"), &value), AZ_OK);
  assert_int_equal(value, 0);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("1024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("+1024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("-1024"), &value), AZ_OK);
  assert_int_equal(value, -1024);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("001024"), &value), AZ_OK);
  assert_int_equal(value, 1024);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("2147483647"), &value), AZ_OK);
  assert_int_equal(value, 2147483647);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("-2147483648"), &value), AZ_OK);
  assert_int_equal(value, -2147483647 - 1);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("4294967295"), &value), AZ_OK);
  assert_int_equal(value, 4294967295);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("-4294967296"), &value), AZ_OK);
  assert_int_equal(value, -4294967296);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("9223372036854775807"), &value), AZ_OK);
  assert_int_equal(value, 9223372036854775807L);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("-9223372036854775808"), &value), AZ_OK);
  assert_int_equal(value, -9223372036854775807L - 1);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("-00009223372036854775808"), &value), AZ_OK);
  assert_int_equal(value, -9223372036854775807L - 1);

  assert_int_equal(
      az_span_atoi64(az_span_create_from_str("92233720368547758070"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi64(az_span_create_from_str("12233720368547758070"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi64(az_span_create_from_str("9223372036854775808"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi64(az_span_create_from_str("18446744073709551615"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi64(az_span_create_from_str("18446744073709551616"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi64(az_span_create_from_str("-9223372036854775809"), &value), AZ_ERROR_UNEXPECTED_CHAR);
}
...
static void az_span_atod_test(void** state)
{
  ...
  assert_int_equal(az_span_atod(az_span_create_from_str("0"), &value), AZ_OK);
  assert_true(value == 0);
  assert_int_equal(az_span_atod(az_span_create_from_str("1024"), &value), AZ_OK);
  assert_true(value == 1024);
  assert_int_equal(az_span_atod(az_span_create_from_str("+1024"), &value), AZ_OK);
  assert_true(value == 1024);
  assert_int_equal(az_span_atod(az_span_create_from_str("001024"), &value), AZ_OK);
  assert_true(value == 1024);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1024"), &value), AZ_OK);
  assert_true(value == -1024);
  assert_int_equal(az_span_atod(az_span_create_from_str("2147483647"), &value), AZ_OK);
  assert_true(value == 2147483647);
  assert_int_equal(az_span_atod(az_span_create_from_str("-2147483648"), &value), AZ_OK);
  assert_true(value == -2147483647 - 1);
  assert_int_equal(az_span_atod(az_span_create_from_str("4294967295"), &value), AZ_OK);
  assert_true(value == 4294967295);
  assert_int_equal(az_span_atod(az_span_create_from_str("-4294967296"), &value), AZ_OK);
  assert_true(value == -4294967296);
  assert_int_equal(az_span_atod(az_span_create_from_str("9223372036854775807"), &value), AZ_OK);
  assert_true(value == 9223372036854775807);
  assert_int_equal(az_span_atod(az_span_create_from_str("-9223372036854775808"), &value), AZ_OK);
  assert_true(value == -2147483647 * (double)4294967298);

  assert_int_equal(az_span_atod(az_span_create_from_str("1.23e3"), &value), AZ_OK);
  assert_true(value == 1.23e3);
  assert_int_equal(az_span_atod(az_span_create_from_str("+001.23e3"), &value), AZ_OK);
  assert_true(value == 1.23e3);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.23"), &value), AZ_OK);
  assert_true(value == 1.23);
  assert_int_equal(az_span_atod(az_span_create_from_str("-123.456e-78"), &value), AZ_OK);
  ...
  assert_int_equal(az_span_atod(az_span_create_from_str("-0"), &value), AZ_OK);
  assert_true(value == 0);
  assert_int_equal(az_span_atod(az_span_create_from_str("0.0"), &value), AZ_OK);
  assert_true(value == 0);
  assert_int_equal(az_span_atod(az_span_create_from_str("1"), &value), AZ_OK);
  assert_true(value == 1);
  assert_int_equal(az_span_atod(az_span_create_from_str("1."), &value), AZ_OK);
  assert_true(value == 1);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.e3"), &value), AZ_OK);
  assert_true(value == 1000);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1"), &value), AZ_OK);
  assert_true(value == -1);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.0"), &value), AZ_OK);
  assert_true(value == 1);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1.0"), &value), AZ_OK);
  assert_true(value == -1);
  assert_int_equal(az_span_atod(az_span_create_from_str("12345"), &value), AZ_OK);
  assert_true(value == 12345);
  assert_int_equal(az_span_atod(az_span_create_from_str("-12345"), &value), AZ_OK);
  assert_true(value == -12345);
  assert_int_equal(az_span_atod(az_span_create_from_str("123.123"), &value), AZ_OK);
  assert_true(value == 123.123);
  assert_int_equal(az_span_atod(az_span_create_from_str("123.1230"), &value), AZ_OK);
  assert_true(value == 123.1230);
  assert_int_equal(az_span_atod(az_span_create_from_str("123.0100"), &value), AZ_OK);
  assert_true(value == 123.0100);
  assert_int_equal(az_span_atod(az_span_create_from_str("123.01"), &value), AZ_OK);
  assert_true(value == 123.01);
  assert_int_equal(az_span_atod(az_span_create_from_str("123.001"), &value), AZ_OK);
  assert_true(value == 123.001);
  assert_int_equal(az_span_atod(az_span_create_from_str("0.000000000000001"), &value), AZ_OK);
  assert_true(value == 0.000000000000001);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.0000000001"), &value), AZ_OK);
  assert_true(value == 1.0000000001);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1.0000000001"), &value), AZ_OK);
  assert_true(value == -1.0000000001);
  assert_int_equal(az_span_atod(az_span_create_from_str("100.001"), &value), AZ_OK);
  assert_true(value == 100.001);
  assert_int_equal(az_span_atod(az_span_create_from_str("100.00100"), &value), AZ_OK);
  assert_true(value == 100.00100);
  assert_int_equal(az_span_atod(az_span_create_from_str("00100.001"), &value), AZ_OK);
  assert_true(value == 00100.001);
  assert_int_equal(az_span_atod(az_span_create_from_str("00100.00100"), &value), AZ_OK);
  assert_true(value == 00100.00100);
  assert_int_equal(az_span_atod(az_span_create_from_str("0.001"), &value), AZ_OK);
  assert_true(value == 0.001);
  assert_int_equal(az_span_atod(az_span_create_from_str("0.0012"), &value), AZ_OK);
  assert_true(value == 0.0012);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.2e4"), &value), AZ_OK);
  assert_true(value == 1.2e4);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.2e-4"), &value), AZ_OK);
  ...
  assert_int_equal(az_span_atod(az_span_create_from_str("-1.2e-4"), &value), AZ_OK);
  assert_true(value == -1.2e-4);
  assert_int_equal(az_span_atod(az_span_create_from_str("0.0001"), &value), AZ_OK);
  assert_true(value == 0.0001);
  assert_int_equal(az_span_atod(az_span_create_from_str("0.00102"), &value), AZ_OK);
  assert_true(value == 0.00102);
  assert_int_equal(az_span_atod(az_span_create_from_str("0.34567"), &value), AZ_OK);
  assert_true(value == .34567);
  assert_int_equal(az_span_atod(az_span_create_from_str("+0.34567"), &value), AZ_OK);
  assert_true(value == .34567);
  assert_int_equal(az_span_atod(az_span_create_from_str("-0.34567"), &value), AZ_OK);
  assert_true(value == -.34567);
  assert_int_equal(az_span_atod(az_span_create_from_str("9876.54321"), &value), AZ_OK);
  assert_true(value == 9876.54321);
  assert_int_equal(az_span_atod(az_span_create_from_str("-9876.54321"), &value), AZ_OK);
  assert_true(value == -9876.54321);
  assert_int_equal(az_span_atod(az_span_create_from_str("987654.321"), &value), AZ_OK);
  assert_true(value == 987654.321);
  assert_int_equal(az_span_atod(az_span_create_from_str("-987654.321"), &value), AZ_OK);
  assert_true(value == -987654.321);
  assert_int_equal(az_span_atod(az_span_create_from_str("987654.0000321"), &value), AZ_OK);
  ...
  assert_int_equal(az_span_atod(az_span_create_from_str("-2147483648"), &value), AZ_OK);
  assert_true(value == -2147483647 - 1);
  assert_int_equal(az_span_atod(az_span_create_from_str("4503599627370496"), &value), AZ_OK);
  assert_true(value == 4503599627370496);
  assert_int_equal(az_span_atod(az_span_create_from_str("9007199254740991"), &value), AZ_OK);
  assert_true(value == 9007199254740991);
  assert_int_equal(az_span_atod(az_span_create_from_str("4503599627370496.2"), &value), AZ_OK);
  assert_true(value == 4503599627370496.2);
  assert_int_equal(az_span_atod(az_span_create_from_str("1e15"), &value), AZ_OK);
  assert_true(value == 1e15);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1e15"), &value), AZ_OK);
  assert_true(value == -1e15);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.8e10"), &value), AZ_OK);
  assert_true(value == 1.8e10);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1.8e10"), &value), AZ_OK);
  assert_true(value == -1.8e10);
  assert_int_equal(az_span_atod(az_span_create_from_str("1e-15"), &value), AZ_OK);
  assert_true(value == 1e-15);
  assert_int_equal(az_span_atod(az_span_create_from_str("1e-10"), &value), AZ_OK);
  assert_true(value == 1e-10);
  assert_int_equal(az_span_atod(az_span_create_from_str("1e-5"), &value), AZ_OK);
  assert_true(value == 1e-5);
  assert_int_equal(az_span_atod(az_span_create_from_str("0.1234567890123456"), &value), AZ_OK);
  assert_true(value == 0.1234567890123456);
  assert_int_equal(
      az_span_atod(az_span_create_from_str("123456789012345.123456789012340000"), &value), AZ_OK);
  assert_true(value == 123456789012345.123456789012340000);
  assert_int_equal(
      az_span_atod(az_span_create_from_str("1000000000000.123456789012340000"), &value), AZ_OK);
  assert_true(value == 1000000000000.123456789012340000);
  assert_int_equal(
      az_span_atod(az_span_create_from_str("123456789012345.1234567890123400001"), &value), AZ_OK);
  assert_true(value == 123456789012345.1234567890123400001);
  assert_int_equal(
      az_span_atod(az_span_create_from_str("1000000000000.1234567890123400001"), &value), AZ_OK);
  assert_true(value == 1000000000000.1234567890123400001);
  assert_int_equal(az_span_atod(az_span_create_from_str("12345.123e-15"), &value), AZ_OK);
  assert_true(value == 12345.123e-15);
  assert_int_equal(az_span_atod(az_span_create_from_str("12345.12300000010e5"), &value), AZ_OK);
  assert_true(value == 12345.12300000010e5);
  assert_int_equal(az_span_atod(az_span_create_from_str("1e-300"), &value), AZ_OK);
  assert_true(value == 1e-300);

  assert_int_equal(az_span_atod(az_span_create_from_str("9007199254740992"), &value), AZ_OK);
  assert_true(value == 9007199254740992);
  assert_int_equal(az_span_atod(az_span_create_from_str("9007199254740993"), &value), AZ_OK);
  assert_true(value == 9007199254740993);
  assert_int_equal(az_span_atod(az_span_create_from_str("45035996273704961"), &value), AZ_OK);
  assert_true(value == 45035996273704961);
  assert_int_equal(az_span_atod(az_span_create_from_str("9223372036854775806"), &value), AZ_OK);
  assert_true(value == 9223372036854775806);
  assert_int_equal(az_span_atod(az_span_create_from_str("-9223372036854775806"), &value), AZ_OK);
  assert_true(value == -9223372036854775806);
  assert_int_equal(az_span_atod(az_span_create_from_str("1844674407370955100"), &value), AZ_OK);
  assert_true(value == 1844674407370955100);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.844674407370955e+19"), &value), AZ_OK);
  assert_true(value == 1.844674407370955e+19);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.8446744073709551e+19"), &value), AZ_OK);
  assert_true(value == 1.8446744073709551e+19);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.8446744073709552e+19"), &value), AZ_OK);
  assert_true(value == 1.8446744073709552e+19);
  assert_int_equal(az_span_atod(az_span_create_from_str("18446744073709551615"), &value), AZ_OK);
  assert_true(value == 18446744073709551615UL);
  assert_int_equal(
      az_span_atod(az_span_create_from_str("18446744073709551615.18446744073709551615"), &value), AZ_OK);
  assert_true(value == 18446744073709551615.18446744073709551615);
  assert_int_equal(
      az_span_atod(az_span_create_from_str("+000018446744073709551615.18446744073709551615"), &value),
      AZ_OK);
  assert_true(value == 18446744073709551615.18446744073709551615);
  assert_int_equal(
      az_span_atod(az_span_create_from_str("-000018446744073709551615.18446744073709551615"), &value),
      AZ_OK);
  assert_true(value == -18446744073709551615.18446744073709551615);
  assert_int_equal(az_span_atod(az_span_create_from_str("1e16"), &value), AZ_OK);
  assert_true(value == 1e16);
  assert_int_equal(az_span_atod(az_span_create_from_str("12345.123e15"), &value), AZ_OK);
  assert_true(value == 12345.123e15);
  assert_int_equal(az_span_atod(az_span_create_from_str("-12345.123e15"), &value), AZ_OK);
  assert_true(value == -12345.123e15);
  assert_int_equal(az_span_atod(az_span_create_from_str("1e300"), &value), AZ_OK);
  assert_true(value == 1e300);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1e300"), &value), AZ_OK);
  assert_true(value == -1e300);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.7e308"), &value), AZ_OK);
  assert_true(value == 1.7e308);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1.7e308"), &value), AZ_OK);
  assert_true(value == -1.7e308);
  assert_int_equal(az_span_atod(az_span_create_from_str("2.22507e-308"), &value), AZ_OK);
  assert_true(value == 2.22507e-308);
  assert_int_equal(az_span_atod(az_span_create_from_str("-2.22507e-308"), &value), AZ_OK);
  assert_true(value == -2.22507e-308);
  assert_int_equal(az_span_atod(az_span_create_from_str("4.94e-325"), &value), AZ_OK);
  assert_true(value == 0);
  assert_int_equal(az_span_atod(az_span_create_from_str("1e-400"), &value), AZ_OK);
  assert_true(value == 0);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1e-400"), &value), AZ_OK);
  assert_true(value == 0);
}
...
static void az_span_atod_non_finite_not_allowed(void** state)
{
  ...
  assert_int_equal(az_span_atod(az_span_create_from_str("nan"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("-nan"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("+nan"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("inf"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("+inf"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("-inf"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("NAN"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("INF"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("+INF"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("-INF"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("INFINITY"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("+INFINITY"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("-INFINITY"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.8e308"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("-1.8e308"), &value), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("1.8e309"), &value), AZ_ERROR_UNEXPECTED_CHAR);
}
...
static void az_span_ato_number_whitespace_or_invalid_not_allowed(void** state)
{
  ...
  assert_int_equal(
      az_span_atoi32(az_span_create_from_str("   123"), &value_i32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("   123"), &value_u32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi64(az_span_create_from_str("   123"), &value_i64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou64(az_span_create_from_str("   123"), &value_u64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("   123"), &value_d), AZ_ERROR_UNEXPECTED_CHAR);

  assert_int_equal(az_span_atoi32(az_span_create_from_str("\n123"), &value_i32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(az_span_create_from_str("\n123"), &value_u32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("\n123"), &value_i64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou64(az_span_create_from_str("\n123"), &value_u64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("\n123"), &value_d), AZ_ERROR_UNEXPECTED_CHAR);

  assert_int_equal(az_span_atoi32(az_span_create_from_str("a123"), &value_i32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(az_span_create_from_str("a123"), &value_u32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("a123"), &value_i64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou64(az_span_create_from_str("a123"), &value_u64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("a123"), &value_d), AZ_ERROR_UNEXPECTED_CHAR);

  assert_int_equal(az_span_atoi32(az_span_create_from_str("- 123"), &value_i32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou32(az_span_create_from_str("- 123"), &value_u32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atoi64(az_span_create_from_str("- 123"), &value_i64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atou64(az_span_create_from_str("- 123"), &value_u64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("- 123"), &value_d), AZ_ERROR_UNEXPECTED_CHAR);

  assert_int_equal(
      az_span_atoi32(az_span_create_from_str("-\n123"), &value_i32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou32(az_span_create_from_str("-\n123"), &value_u32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atoi64(az_span_create_from_str("-\n123"), &value_i64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(
      az_span_atou64(az_span_create_from_str("-\n123"), &value_u64), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_create_from_str("-\n123"), &value_d), AZ_ERROR_UNEXPECTED_CHAR);
}
...
static void az_span_ato_number_no_out_of_bounds_reads(void** state)
{
  ...
  az_span source = az_span_create_from_str("   123456");
  ...
  source = az_span_create_from_str("   123A");
  // Makes sure we only read and parse up to the character '3', since that is the last character
  // within the span slice
  assert_int_equal(
      az_span_atoi32(az_span_slice(source, 0, 6), &value_i32), AZ_ERROR_UNEXPECTED_CHAR);
  ...
  source = az_span_create_from_str("   123.");
  // Makes sure we only read and parse up to the character '3', since that is the last character
  // within the span slice
  assert_int_equal(
      az_span_atoi32(az_span_slice(source, 0, 6), &value_i32), AZ_ERROR_UNEXPECTED_CHAR);
  ...
  source = az_span_create_from_str("   12-4");
  assert_int_equal(
      az_span_atoi32(az_span_slice(source, 0, 6), &value_i32), AZ_ERROR_UNEXPECTED_CHAR);
  assert_int_equal(az_span_atod(az_span_slice(source, 0, 6), &value_d), AZ_ERROR_UNEXPECTED_CHAR);
  ...
  source = az_span_create_from_str("n1");
...
{
  az_span sample = az_span_create_from_str("hello World!");
  char str[20];
...
{
  az_span span = az_span_create_from_str("abcdefgabcdefg");
  az_span target = az_span_create_from_str("abc");
...
{
  az_span span = az_span_create_from_str("abcdefgabcdefg");
  az_span target = az_span_create_from_str("gab");
...
{
  az_span span = az_span_create_from_str("abcdefgabcdefgh");
  az_span target = az_span_create_from_str("efgh");
...
{
  az_span span = az_span_create_from_str("abcdefgabcdefg");
  az_span target = az_span_create_from_str("abcdefgabcdefg");
...
{
  az_span span = az_span_create_from_str("abcdefgabcdefg");
  az_span target = az_span_create_from_str("abd");
...
{
  az_span span = az_span_create_from_str("aa");
  az_span target = az_span_create_from_str("aaa");
...
{
  az_span span = az_span_create_from_str("abcd");
  az_span target = az_span_create_from_str("cde");
...
{
  az_span span = az_span_create_from_str("abcd");
  az_span target = az_span_create_from_str("zab");
...
{
  az_span span = az_span_create_from_str("abcdefghij");
...
{
  az_span span = az_span_create_from_str("abcd\0\0fghij");
  az_span target = az_span_create_from_str("\0\0");
...
static void az_span_i64toa_test(void** state)
{
  ...
  int64_t number = 123;
  az_span number_str = az_span_create_from_str("123");
  uint64_t reverse;
...
static void az_span_copy_uint8_succeeds(void** state)
{
  ...
  assert_true(az_span_is_content_equal(
      az_span_slice(AZ_SPAN_FROM_BUFFER(raw_buffer), 0, 3), az_span_create_from_str("abc")));
}
...
static void az_span_i32toa_succeeds(void** state)
{
  ...
  assert_true(az_span_is_content_equal(
      az_span_slice(AZ_SPAN_FROM_BUFFER(raw_buffer), 0, 5), az_span_create_from_str("12345")));
}
...
static void az_span_i32toa_negative_succeeds(void** state)
{
  ...
  assert_true(az_span_is_content_equal(
      az_span_slice(AZ_SPAN_FROM_BUFFER(raw_buffer), 0, 6), az_span_create_from_str("-12345")));
}
...
static void az_span_i32toa_zero_succeeds(void** state)
{
  ...
  assert_true(az_span_is_content_equal(
      az_span_slice(AZ_SPAN_FROM_BUFFER(raw_buffer), 0, 1), az_span_create_from_str("0")));
}
...
static void az_span_i32toa_max_int_succeeds(void** state)
{
  ...
  assert_true(az_span_is_content_equal(
      az_span_slice(AZ_SPAN_FROM_BUFFER(raw_buffer), 0, 10), az_span_create_from_str("2147483647")));
}
...
static void az_span_u32toa_max_uint_succeeds(void** state)
{
  ...
  assert_int_equal(az_span_size(out_span), 5);
  assert_true(az_span_is_content_equal(
      az_span_slice(AZ_SPAN_FROM_BUFFER(raw_buffer), 0, 10), az_span_create_from_str("4294967295")));
}
...
static void az_span_dtoa_succeeds(void** state)
{
  ...
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0, 15, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1., 15, az_span_create_from_str("1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.e3, 15, az_span_create_from_str("1000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-0, 15, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.0, 15, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1, 15, az_span_create_from_str("1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1, 15, az_span_create_from_str("-1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.0, 15, az_span_create_from_str("1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.0, 15, az_span_create_from_str("-1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(12345, 15, az_span_create_from_str("12345"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-12345, 15, az_span_create_from_str("-12345"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(123.123, 15, az_span_create_from_str("123.123000000000004"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(123.1230, 15, az_span_create_from_str("123.123000000000004"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(123.0100, 15, az_span_create_from_str("123.010000000000005"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(123.001, 15, az_span_create_from_str("123.001000000000004"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.000000000000001, 15, az_span_create_from_str("0.000000000000001"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.0000000001, 15, az_span_create_from_str("1.0000000001"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.0000000001, 15, az_span_create_from_str("-1.0000000001"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(100.001, 15, az_span_create_from_str("100.001000000000004"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(100.00100, 15, az_span_create_from_str("100.001000000000004"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(00100.001, 15, az_span_create_from_str("100.001000000000004"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(00100.00100, 15, az_span_create_from_str("100.001000000000004"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.001, 15, az_span_create_from_str("0.001"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.0012, 15, az_span_create_from_str("0.001199999999999"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.2e4, 15, az_span_create_from_str("12000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.2e-4, 15, az_span_create_from_str("0.00012"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.2e+4, 15, az_span_create_from_str("12000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.2e4, 15, az_span_create_from_str("-12000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.2e-4, 15, az_span_create_from_str("-0.00012"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.0001, 15, az_span_create_from_str("0.0001"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.00102, 15, az_span_create_from_str("0.00102"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(.34567, 15, az_span_create_from_str("0.34567"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(+.34567, 15, az_span_create_from_str("0.34567"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-.34567, 15, az_span_create_from_str("-0.34567"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(9876.54321, 15, az_span_create_from_str("9876.543209999999817"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-9876.54321, 15, az_span_create_from_str("-9876.543209999999817"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(987654.321, 15, az_span_create_from_str("987654.320999999996274"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-987654.321, 15, az_span_create_from_str("-987654.320999999996274"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(987654.0000321, 15, az_span_create_from_str("987654.000032100011594"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(2147483647, 15, az_span_create_from_str("2147483647"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(2 * (double)1073741824, 15, az_span_create_from_str("2147483648"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-2147483647 - 1, 15, az_span_create_from_str("-2147483648"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(4503599627370496, 15, az_span_create_from_str("4503599627370496"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(9007199254740991, 15, az_span_create_from_str("9007199254740991"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      (double)4503599627370496.2, 15, az_span_create_from_str("4503599627370496"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e15, 15, az_span_create_from_str("1000000000000000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1e15, 15, az_span_create_from_str("-1000000000000000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.8e10, 15, az_span_create_from_str("18000000000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.8e10, 15, az_span_create_from_str("-18000000000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e-15, 15, az_span_create_from_str("0.000000000000001"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e-10, 15, az_span_create_from_str("0.0000000001"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e-5, 15, az_span_create_from_str("0.00001"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.1234567890123456, 15, az_span_create_from_str("0.123456789012345"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      123456789012345.123456789012340000, 15, az_span_create_from_str("123456789012345.125"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      1000000000000.123456789012340000, 15, az_span_create_from_str("1000000000000.1234130859375"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      123456789012345.1234567890123400001, 15, az_span_create_from_str("123456789012345.125"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      1000000000000.1234567890123400001, 15, az_span_create_from_str("1000000000000.1234130859375"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(12345.123e-15, 15, az_span_create_from_str("0.000000000012345"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      12345.12300000010e5, 15, az_span_create_from_str("1234512300.000010013580322"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e-300, 15, az_span_create_from_str("0"));

  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1., 2, az_span_create_from_str("1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.e3, 2, az_span_create_from_str("1000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-0, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.0, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1, 2, az_span_create_from_str("1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1, 2, az_span_create_from_str("-1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.0, 2, az_span_create_from_str("1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.0, 2, az_span_create_from_str("-1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(12345, 2, az_span_create_from_str("12345"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-12345, 2, az_span_create_from_str("-12345"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(123.123, 2, az_span_create_from_str("123.12"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(123.1230, 2, az_span_create_from_str("123.12"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(123.0100, 2, az_span_create_from_str("123.01"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(123.001, 2, az_span_create_from_str("123"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.000000000000001, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.0000000001, 2, az_span_create_from_str("1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.0000000001, 2, az_span_create_from_str("-1"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(100.001, 2, az_span_create_from_str("100"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(100.00100, 2, az_span_create_from_str("100"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(00100.001, 2, az_span_create_from_str("100"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(00100.00100, 2, az_span_create_from_str("100"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.001, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.0012, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.2e4, 2, az_span_create_from_str("12000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.2e-4, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.2e+4, 2, az_span_create_from_str("12000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.2e4, 2, az_span_create_from_str("-12000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.2e-4, 2, az_span_create_from_str("-0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.0001, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.00102, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(.34567, 2, az_span_create_from_str("0.34"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(+.34567, 2, az_span_create_from_str("0.34"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-.34567, 2, az_span_create_from_str("-0.34"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(9876.54321, 2, az_span_create_from_str("9876.54"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-9876.54321, 2, az_span_create_from_str("-9876.54"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(987654.321, 2, az_span_create_from_str("987654.32"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-987654.321, 2, az_span_create_from_str("-987654.32"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(987654.0000321, 2, az_span_create_from_str("987654"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(2147483647, 2, az_span_create_from_str("2147483647"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(2 * (double)1073741824, 2, az_span_create_from_str("2147483648"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-2147483647 - 1, 2, az_span_create_from_str("-2147483648"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(4503599627370496, 2, az_span_create_from_str("4503599627370496"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(9007199254740991, 2, az_span_create_from_str("9007199254740991"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER((double)4503599627370496.2, 2, az_span_create_from_str("4503599627370496"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e15, 2, az_span_create_from_str("1000000000000000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1e15, 2, az_span_create_from_str("-1000000000000000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1.8e10, 2, az_span_create_from_str("18000000000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(-1.8e10, 2, az_span_create_from_str("-18000000000"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e-15, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e-10, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e-5, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(0.1234567890123456, 2, az_span_create_from_str("0.12"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      123456789012345.123456789012340000, 2, az_span_create_from_str("123456789012345.12"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      1000000000000.123456789012340000, 2, az_span_create_from_str("1000000000000.12"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      123456789012345.1234567890123400001, 2, az_span_create_from_str("123456789012345.12"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(
      1000000000000.1234567890123400001, 2, az_span_create_from_str("1000000000000.12"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(12345.123e-15, 2, az_span_create_from_str("0"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(12345.12300000010e5, 2, az_span_create_from_str("1234512300"));
  AZ_SPAN_DTOA_SUCCEEDS_HELPER(1e-300, 2, az_span_create_from_str("0"));
...
static void test_az_span_is_valid(void** state)
{
  ...
  (void)state;
  assert_true(_az_span_is_valid(empty_span, 0, true));
  assert_false(_az_span_is_valid(empty_span, 0, false));
  assert_false(_az_span_is_valid(empty_span, 1, true));
  assert_false(_az_span_is_valid(empty_span, 1, false));
  assert_false(_az_span_is_valid(empty_span, -1, true));
  assert_false(_az_span_is_valid(empty_span, -1, false));
  ...
  assert_true(_az_span_is_valid(az_span_create_from_str(""), 0, true));
  assert_true(_az_span_is_valid(az_span_create_from_str(""), 0, false));
  assert_false(_az_span_is_valid(az_span_create_from_str(""), 1, true));
  assert_false(_az_span_is_valid(az_span_create_from_str(""), 1, false));
  assert_false(_az_span_is_valid(az_span_create_from_str(""), -1, true));
  assert_false(_az_span_is_valid(az_span_create_from_str(""), -1, false));

  assert_true(_az_span_is_valid(az_span_create_from_str("Hello"), 0, true));
  assert_true(_az_span_is_valid(az_span_create_from_str("Hello"), 0, false));
  assert_true(_az_span_is_valid(az_span_create_from_str("Hello"), 1, true));
  assert_true(_az_span_is_valid(az_span_create_from_str("Hello"), 1, false));
  assert_true(_az_span_is_valid(az_span_create_from_str("Hello"), 5, true));
  assert_true(_az_span_is_valid(az_span_create_from_str("Hello"), 5, false));
  assert_false(_az_span_is_valid(az_span_create_from_str("Hello"), 6, true));
  assert_false(_az_span_is_valid(az_span_create_from_str("Hello"), 6, false));
  assert_false(_az_span_is_valid(az_span_create_from_str("Hello"), -1, true));
  assert_false(_az_span_is_valid(az_span_create_from_str("Hello"), -1, false));
...
{
  az_span source = _az_span_trim_whitespace(az_span_create_from_str("   abc   "));
  assert_true(az_span_is_content_equal(source, az_span_create_from_str("abc")));
  (void)state;
}

static void az_span_trim_left(void** state)
{
  az_span source = _az_span_trim_whitespace_from_start(az_span_create_from_str("   abc   "));
  assert_true(az_span_is_content_equal(source, az_span_create_from_str("abc   ")));
  (void)state;
}
...
{
  az_span source = _az_span_trim_whitespace_from_end(az_span_create_from_str("   abc   "));
  assert_true(az_span_is_content_equal(source, az_span_create_from_str("   abc")));
  (void)state;
}
...
{
  az_span source = _az_span_trim_whitespace(az_span_create_from_str("\t\n\r       "));
...
{
  az_span source = _az_span_trim_whitespace(az_span_create_from_str("\ta\n b     c    "));
  assert_true(az_span_is_content_equal(source, az_span_create_from_str("a\n b     c")));
  (void)state;
}
...
{
  az_span source = _az_span_trim_whitespace(az_span_create_from_str(""));
  assert_true(az_span_is_content_equal(source, az_span_create_from_str("")));
  (void)state;
}
...
{
  az_span source = _az_span_trim_whitespace_from_end(az_span_create_from_str("\ta\n b     c    "));
  assert_true(az_span_is_content_equal(source, az_span_create_from_str("\ta\n b     c")));
  (void)state;
}
...
{
  az_span source
      = _az_span_trim_whitespace_from_end(az_span_create_from_str("  \\U+00A0a\n b     c\\U+2028    "));
  assert_true(az_span_is_content_equal(source, az_span_create_from_str("  \\U+00A0a\n b     c\\U+2028")));
  (void)state;
}
...
static void az_span_trim_two_calls_inverse(void** state)
{
  az_span source = _az_span_trim_whitespace_from_end(
      _az_span_trim_whitespace_from_start(az_span_create_from_str("  \\U+00A0a\n b     c\\U+2028    ")));
  assert_true(az_span_is_content_equal(source, az_span_create_from_str("\\U+00A0a\n b     c\\U+2028")));
  (void)state;
}
...
{
  az_span source = _az_span_trim_whitespace_from_end(
      _az_span_trim_whitespace_from_start(az_span_create_from_str("  1234    ")));
  source = _az_span_trim_whitespace(source);
  source = _az_span_trim_whitespace(source);
  source = _az_span_trim_whitespace(source);
  assert_true(az_span_is_content_equal(source, az_span_create_from_str("1234")));
  (void)state;
}

static void test_az_span_token_success(void** state)
{
  az_span span = az_span_create_from_str("abcdefgabcdefgabcdefg");
  az_span delim = az_span_create_from_str("abc");
  az_span token;
  az_span out_span;
  int32_t index = 0;
